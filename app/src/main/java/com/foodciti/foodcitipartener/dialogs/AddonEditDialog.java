...
public class AddonEditDialog extends DialogFragment implements View.OnFocusChangeListener, View.OnKeyListener {
    private static final String TAG = "AddonEditDialog";
    ...
    private String name = "", price = "", titleStr = "";
    ...
    public static AddonEditDialog newInstance() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dialog_addonedit_layout, container, false);
    ...
    private void done2() {
        if (callback != null)
            callback.onClickDone(AddonEditDialog.this, nameET, priceET, selectedColorId);
    }
...
//            price.delete(0, price.length());
    ...
    public interface Callback {
        void onClickDone(AddonEditDialog dialog, EditText name, EditText price, long colorId);
    }
}

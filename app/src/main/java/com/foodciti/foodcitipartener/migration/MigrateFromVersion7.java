...
public class MigrateFromVersion7 implements MigrationHelper{
    ...
    private void modifyVendorSchema(RealmSchema schema) throws Exception {
        ...
        try {
            ...
            if(objectSchema.hasField("optInHomePage"))
                return;
            Log.d(TAG, "------------adding field 'optInHomePage'");
            objectSchema.addField("optInHomePage", String.class);
        } finally {

...
//import com.foodciti.foodcitipartener.realm_entities.AddonGroup;
...
//
//public class AddonGroupDialoge extends DialogFragment implements View.OnFocusChangeListener, View.OnKeyListener {
//
...
//    }
//
//    private AddonGroupDialoge(){}
//
//    public static AddonGroupDialoge newInstance(int position, long itemId, String itemType, String orderType) {
//        AddonGroupDialoge itemEditDialog = new AddonGroupDialoge();
...
//    }
//
//    public static AddonGroupDialoge newInstance(int position, long itemId, long parentId, String itemType, String orderType) {
//        AddonGroupDialoge itemEditDialog = new AddonGroupDialoge();
//        Bundle args = new Bundle();
//        args.putInt(ARG_POSITION, position);
//        args.putLong(ARG_ITEM_ID, itemId);
...
//        String price = "";
//        AddonGroup menuItem = realm.where(AddonGroup.class).equalTo("id", itemId).findFirst();
//        final AddonGroup parent = realm.where(AddonGroup.class).equalTo("id", parentId).findFirst();
//
//        AtomicReference<AddonGroup> atomicReference = new AtomicReference<>(menuItem);
...
//
//                atomicReference.set(r.createObject(AddonGroup.class, nextId));
...
//                if (callback != null)
//                    callback.onClickDone(AddonGroupDialoge.this, position, atomicReference.get().id, true, isFlavour);
//            } else {
//                String name = nameET.getText().toString().trim();
//                String capitalizedName = StringHelper.capitalizeEachWord(name);
//                atomicReference.get().name = capitalizedName;
...
//                    atomicReference.get().color = Color.parseColor(itemColor.getHexCode().trim());
//                if (callback != null)
//                    callback.onClickDone(AddonGroupDialoge.this, position, atomicReference.get().id, false, false);
//            }
//        });
//    }
//
...
//        void onClickDone(AddonGroupDialoge dialog, int position, long menuItemId, boolean justCreated, boolean isFlavour);
//    }
//}

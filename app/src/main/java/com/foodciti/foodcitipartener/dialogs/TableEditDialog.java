...
public class TableEditDialog extends DialogFragment implements View.OnFocusChangeListener, View.OnKeyListener {
    private static final String TAG = "TableEditDialog";
    ...
    private TableEditDialog(){}

    public static TableEditDialog newInstance() {
        TableEditDialog tableEditDialog = new TableEditDialog();
        tableEditDialog.setCancelable(true);
        return tableEditDialog;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dialog_tableedit_layout, container, false);
    ...
    private void done2() {
        if (callback != null)
            callback.onClickDone(TableEditDialog.this, nameET);
    }
...
//            price.delete(0, price.length());
    ...
    public interface Callback {
        void onClickDone(TableEditDialog dialog, EditText name);
    }
}

...
public class CustomFileSaveDialog extends DialogFragment {
    private static final String TAG = "CustomFileSaveDialog";
    ...
    private CustomFileSaveDialog(){}

    public static CustomFileSaveDialog newInstance() {
        CustomFileSaveDialog fileSaveDialog = new CustomFileSaveDialog();
        fileSaveDialog.setCancelable(true);
...
//                fileDialogAdapter.setFiles(file.listFiles(f->f.isDirectory()));
    ...
    public interface Callback {
        void onSelect(CustomFileSaveDialog fileDialog, File file);
    }
}

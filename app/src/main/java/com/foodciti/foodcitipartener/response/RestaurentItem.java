...
public class RestaurentItem implements Parcelable {
    @JsonProperty("_id")
    private String id;
    ...
    private List<SubInfo> itemSubCategory;
    ...
    public List<SubInfo> getItemSubCategory() {
        return itemSubCategory;
    }

    public void setItemSubCategory(List<SubInfo> itemSubCategory) {
    ...
    public RestaurentItem() {
    }

    protected RestaurentItem(Parcel in) {
        ...
        this.itemSubCategory = in.createTypedArrayList(SubInfo.CREATOR);
        this.itemQuantityOrdered = in.readInt();
        this.itemStock = in.readInt();
        this.itemIllustration = in.createStringArrayList();
    }

    public static final Creator<RestaurentItem> CREATOR = new Creator<RestaurentItem>() {
        @Override
        public RestaurentItem createFromParcel(Parcel source) {
            return new RestaurentItem(source);
        }

        @Override
        public RestaurentItem[] newArray(int size) {
            return new RestaurentItem[size];
        }
    };
}
